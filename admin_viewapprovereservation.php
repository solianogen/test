...
<br>
<center><h1 style="font-family: Century Gothic,Arial; color:maroon">Approved Reservations</h1></center>
<?php 
    include 'config.php';
    /*session_start();*/
    $idnumber = $_SESSION['idnumber'];
    $fname = $_SESSION['fname'];
    $result = mysqli_query($db, "SELECT * FROM reservation INNER JOIN users ON reservation.idnumber = users.idnumber WHERE status = 'approve'");
?>
<div class="table">
