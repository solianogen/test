    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item hover" href="#">Grade 12</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<br>
    ...
    $query = mysqli_query($db,"SELECT * FROM grade1 WHERE grade = 12 ORDER BY id ASC");
        ...
        ?>
            <div class="col-md-3" style="margin-top:5px; width:360px;">  
                <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:478px;" align="center">
                      ...
                      <a href="grade12.php?cart=<?php echo $res['id']; ?>" name="purchase" class="btn btn-success">Add to Cart</a>
