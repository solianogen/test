  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item hover" href="#">Approved</a>
          <div class="dropdown-divider"></div>
...
<br>
    ...
    $result = mysqli_query($db, "SELECT * FROM grade1 INNER JOIN reservation ON grade1.id = reservation.bookid WHERE reservation.idnumber = $idnumber AND reservation.status = 'approve'");
?>
    <div class="table">
